 ...
 * 
 */
@WebServiceClient(name = "BookImplService", targetNamespace = "http://service.nt.com/", wsdlLocation = "file:/D:/Java%20Package/WebServices/JAX-WS06-RI-Provider-CFA-BookStore/WebContent/WEB-INF/searchBook.wsdl")
    ...
    extends Service
{
    ...
    private final static QName BOOKIMPLSERVICE_QNAME = new QName("http://service.nt.com/", "BookImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/Java%20Package/WebServices/JAX-WS06-RI-Provider-CFA-BookStore/WebContent/WEB-INF/searchBook.wsdl");
    ...
    public Book getBookImplPort() {
        return super.getPort(new QName("http://service.nt.com/", "BookImplPort"), Book.class);
    }
    ...
    public Book getBookImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.nt.com/", "BookImplPort"), Book.class, features);
    }
