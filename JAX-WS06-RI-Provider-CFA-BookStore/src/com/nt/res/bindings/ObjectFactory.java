...
public class ObjectFactory {
    ...
    private final static QName _BookResType_QNAME = new QName("http://com/nt/res/bindings", "BookResType");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com/nt/res/bindings", name = "BookResType")
    public JAXBElement<BookResType> createBookResType(BookResType value) {
        return new JAXBElement<BookResType>(_BookResType_QNAME, BookResType.class, null, value);
    }
