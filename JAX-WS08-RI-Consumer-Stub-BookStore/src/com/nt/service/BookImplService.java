 ...
 * 
 */
@WebServiceClient(name = "BookImplService", targetNamespace = "http://service.nt.com/", wsdlLocation = "http://localhost:2525/JAX-WS07-RI-provider-CLA-BookStoreSimple/searchBook?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:2525/JAX-WS07-RI-provider-CLA-BookStoreSimple/searchBook?wsdl");
